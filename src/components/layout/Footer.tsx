...
const navigation = {
  explore: [
    ...
    { name: 'Destinations', href: '/plan' },
    { name: 'Travel Guides', href: '/how-it-works' },
  ],
  features: [
    { name: 'Multi-City Planning', href: '/plan' },
    { name: 'Budget Allocation', href: '/plan' },
    { name: 'AI Recommendations', href: '/plan' },
    { name: 'Itinerary Builder', href: '/plan' },
    { name: 'Trip Sharing', href: '/plan' },
  ],
  company: [
    { name: 'About Us', href: '/how-it-works' },
    { name: 'Blog', href: '/blog' },
    { name: 'Partners', href: '/how-it-works' },
    { name: 'Careers', href: '/how-it-works' },
    { name: 'Press', href: '/blog' },
  ],
  legal: [
    { name: 'Privacy', href: '/how-it-works' },
    { name: 'Terms', href: '/how-it-works' },
    { name: 'Cookie Policy', href: '/how-it-works' },
  ],
  social: [
    {
      name: 'Facebook',
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">
              Smart multi-city trip planning with AI-powered recommendations and budget optimization.
            </p>
